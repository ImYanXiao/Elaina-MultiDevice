...
//---------------------------------
var handler  = async (m, { conn, command, args, usedPrefix, isPrems }) => {
...
const sections = [
   {
	...
	{title: `${(ch == true ? false : bsdm) == true ? p:f}` + "B • Bsdm", rowId: "${usedPrefix}nsfw bsdm"},
	{title: `${(ch == true ? false : cuckold) == true ? p:f}` + "C • Cuckold", rowId: "${usedPrefix}nsfw cuckold"},
	{title: `${(ch == true ? false : cums) == true ? p:f}` + "C • Cumsluts", rowId: "${usedPrefix}nsfw cums"},
	{title: `${(ch == true ? false : eba) == true ? p:f}` + "E • Eba", rowId: "${usedPrefix}nsfw eba"},
  ...
  //{title: `${(ch == true ? false : eroneko) == true ? p:f}` + "E • Ero Neko", rowId: "${usedPrefix}nsfw eroneko"},
	...
	{title: `${(ch == true ? false : foot) == true ? p:f}` + "F • Foot", rowId: "${usedPrefix}nsfw foot"},
	...
	{title: `${(ch == true ? false : gangbang) == true ? p:f}` + "G • Gangbang", rowId: "${usedPrefix}nsfw gangbang"},
  //{title: `${(ch == true ? false : girlsolo) == true ? p:f}` + "G • Girl Solo", rowId: "${usedPrefix}nsfw girlsolo"},
    {title: `${(ch == true ? false : glasses) == true ? p:f}` + "G • Glasses", rowId: "${usedPrefix}nsfw glasses"},
  ...
  //{title: `${(ch == true ? false : kuni) == true ? p:f}` + "K • Kuni", rowId: "${usedPrefix}nsfw kuni"},
	...
	{title: `${(ch == true ? false : orgy) == true ? p:f}` + "O • Orgy", rowId: "${usedPrefix}nsfw orgy"},
	...
	{title: `${(ch == true ? false : zettai) == true ? p:f}` + "Z • Zettai", rowId: "${usedPrefix}nsfw zettai"},
	]
    },
]
