...
case 'waifu':
  ...
  conn.sendButton(m.chat, 'Random Image Waifu', wm, json.url, [['waifu', `${usedPrefix}waifu`]], m)
break
...
case 'neko':
  ...
  conn.sendButton(m.chat,  'Random Image Neko', wm, neko.url, [['Next','.neko']],m)
break 
...
case 'megumin':
  ...
  conn.sendButton(m.chat, 'Random Image Megumin', wm, megumin.url, [['Next','.megumin']],m)
break
