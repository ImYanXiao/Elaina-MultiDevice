...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  try {
    // Fetch data dari API Tenor dengan parameter yang sudah diformat
    ...
    // Mendownload gambar dan mengonversinya ke buffer
