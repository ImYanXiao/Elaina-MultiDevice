...
var handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    const images = tiktokData.data.images; // Ambil gambar dari data
    const audioURL = tiktokData.data.music; // Ambil URL audio dari data
...
// Fungsi untuk mengonversi video menjadi MP3
