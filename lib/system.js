...
const TOKEN = process.env.GITHUB_TOKEN || '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'
/* Ini Cuman repo public buat bata Repository orang lain saja
*/
...
function requestJSON(url) {
  return new Promise((resolve, reject) => {
    const headers = { 'User-Agent': 'Elaina-Updater' }
