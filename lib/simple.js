...
msToDate: {
   async value (ms) {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        // buat peringatan apa yang sedang terjadi pada server ketika memberikan perintah .menu
	//jika mengalami masalah akan mengirimkan pesan entah berupa koneksi error atau yang lain
        var baper = await Jimp.read(buffer);
        // pake resizeAsync ketika mengubah ukuran
